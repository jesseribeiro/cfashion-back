...
@Slf4j
public class VendasPDF extends RelatorioBasePDF {
    ...
    public VendasPDF(List<VendaDTO> dados, FiltroRelatorioDTO filtro, String diretorio) throws FileNotFoundException, DocumentException {
